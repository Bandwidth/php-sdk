...
------------ | ------------- | ------------- | -------------
**business_address** | [**\OpenAPI\Client\Model\Address**](Address.md) |  |
**business_contact** | [**\OpenAPI\Client\Model\Contact**](Contact.md) |  |
...
**opt_in_workflow** | [**\OpenAPI\Client\Model\OptInWorkflow**](OptInWorkflow.md) |  |
...
**business_entity_type** | [**\OpenAPI\Client\Model\BusinessEntityTypeEnum**](BusinessEntityTypeEnum.md) |  |
