...
**type** | [**\OpenAPI\Client\Model\InboundCallbackTypeEnum**](InboundCallbackTypeEnum.md) |  |
...
**message** | [**\OpenAPI\Client\Model\InboundCallbackMessage**](InboundCallbackMessage.md) |  |
