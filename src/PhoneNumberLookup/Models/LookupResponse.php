...
/**
 * TN Lookup Response for Sync and Async Bulk Phone Number Lookup
 */
class LookupResponse implements \JsonSerializable
{
    /**
     ...
     * @var \BandwidthLib\PhoneNumberLookup\Models\LookupResponseData|null $data public property
     */
    public $data;
