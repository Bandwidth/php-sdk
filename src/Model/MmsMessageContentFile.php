...
/**
 * MmsMessageContentFile Class Doc Comment
 *
 * @package  Bandwidth
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MmsMessageContentFile implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'mmsMessageContentFile';
    ...
    public function setFileUrl(string $file_url): static
    {
        ...
        if ((mb_strlen($file_url) > 1000)) {
            throw new InvalidArgumentException('invalid length for $file_url when calling MmsMessageContentFile., must be smaller than or equal to 1000.');
        }
