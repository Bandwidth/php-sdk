...
class Transcription implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'transcription';
     ...
     * Sets confidence
     *
     * @param float|null $confidence The confidence on the recognized content, ranging from `0.0` to `1.0` with `1.0` being the highest confidence.
     *
     * @return $this
     */
