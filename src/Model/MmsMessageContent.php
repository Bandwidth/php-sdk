 ...
 */
class MmsMessageContent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'mmsMessageContent';
    ...
    public function setText(?string $text): static
    {
        ...
        if ((mb_strlen($text) > 2048)) {
            throw new InvalidArgumentException('invalid length for $text when calling MmsMessageContent., must be smaller than or equal to 2048.');
        }
