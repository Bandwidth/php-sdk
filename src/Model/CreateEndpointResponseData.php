...
/**
 * CreateEndpointResponseData Class Doc Comment
 *
 * @package  Bandwidth
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateEndpointResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'createEndpointResponseData';
     ...
     * Sets token
     *
     * @param string $token The json web token specific to the endpoint. Used to authenticate the client with the media gateway.
     *
     * @return $this
     */
