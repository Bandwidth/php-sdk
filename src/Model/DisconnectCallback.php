...
/**
 * DisconnectCallback Class Doc Comment
 *
 ...
 */
class DisconnectCallback implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'disconnectCallback';
