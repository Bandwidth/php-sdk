...
class PhoneNumber extends Verb implements OutboundDestination
{
    /**
     * @param string          $number                       The phone number to transfer the call to, in E.164 format.
    ...
    public function __construct(
        ...
        parent::__construct('PhoneNumber', $number);
    }
