 ...
 */
class CreateAsyncBulkLookupResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'createAsyncBulkLookupResponse_data';
