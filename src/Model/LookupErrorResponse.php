 ...
 */
class LookupErrorResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'lookupErrorResponse';
     ...
     * Sets data
     *
     * @param object|null $data The phone number lookup response data
     *
     * @return $this
     */
