...
/**
 * RbmMessageContentFile Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RbmMessageContentFile implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'rbmMessageContentFile';
    ...
    public function setFileUrl(string $file_url): static
    {
        ...
        if ((mb_strlen($file_url) > 1000)) {
            throw new InvalidArgumentException('invalid length for $file_url when calling RbmMessageContentFile., must be smaller than or equal to 1000.');
        }
    ...
    public function setThumbnailUrl(?string $thumbnail_url): static
    {
        ...
        if ((mb_strlen($thumbnail_url) > 1000)) {
            throw new InvalidArgumentException('invalid length for $thumbnail_url when calling RbmMessageContentFile., must be smaller than or equal to 1000.');
        }
