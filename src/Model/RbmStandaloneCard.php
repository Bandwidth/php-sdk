 ...
 */
class RbmStandaloneCard implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'rbmStandaloneCard';
    ...
    public function setSuggestions(?array $suggestions): static
    {
        ...
        if ((count($suggestions) > 11)) {
            throw new InvalidArgumentException('invalid value for $suggestions when calling RbmStandaloneCard., number of items must be less than or equal to 11.');
        }
