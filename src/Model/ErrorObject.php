...
class ErrorObject implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'errorObject';
     ...
     * Sets type
     *
     * @param string $type A concise summary of the error used for categorization.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description A detailed explanation of the error.
     *
     * @return $this
     */
