 ...
 */
class MultiChannelAction implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'multiChannelAction';
    ...
    public const TYPE_CREATE_CALENDAR_EVENT = 'CREATE_CALENDAR_EVENT';
    public const TYPE_DIAL_PHONE = 'DIAL_PHONE';
    public const TYPE_OPEN_URL = 'OPEN_URL';
    public const TYPE_REPLY = 'REPLY';
    public const TYPE_REQUEST_LOCATION = 'REQUEST_LOCATION';
    public const TYPE_SHOW_LOCATION = 'SHOW_LOCATION';
    ...
    public function setText(string $text): static
    {
        ...
        if ((mb_strlen($text) > 25)) {
            throw new InvalidArgumentException('invalid length for $text when calling MultiChannelAction., must be smaller than or equal to 25.');
        }
    ...
    public function setPostbackData(string $postback_data): static
    {
        ...
        if ((mb_strlen($postback_data) > 2048)) {
            throw new InvalidArgumentException('invalid length for $postback_data when calling MultiChannelAction., must be smaller than or equal to 2048.');
        }
    ...
    public function setLabel(?string $label): static
    {
        ...
        if ((mb_strlen($label) > 100)) {
            throw new InvalidArgumentException('invalid length for $label when calling MultiChannelAction., must be smaller than or equal to 100.');
        }
    ...
    public function setTitle(string $title): static
    {
        ...
        if ((mb_strlen($title) > 100)) {
            throw new InvalidArgumentException('invalid length for $title when calling MultiChannelAction., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription(?string $description): static
    {
        ...
        if ((mb_strlen($description) > 500)) {
            throw new InvalidArgumentException('invalid length for $description when calling MultiChannelAction., must be smaller than or equal to 500.');
        }
    ...
    public function setUrl(string $url): static
    {
        ...
        if ((mb_strlen($url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $url when calling MultiChannelAction., must be smaller than or equal to 2048.');
        }
