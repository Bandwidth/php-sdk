 ...
 */
class VerificationDenialWebhook implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'verificationDenialWebhook';
    ...
    protected static array $openAPINullables = [
        'account_id' => false,
        'additional_denial_reasons' => false,
        'decline_reason_description' => false,
        'denial_status_code' => false,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('status', $data ?? [], 'UNVERIFIED');
    ...
    public function setAdditionalDenialReasons(?array $additional_denial_reasons): static
    {
        if (is_null($additional_denial_reasons)) {
            throw new InvalidArgumentException('non-nullable additional_denial_reasons cannot be null');
        }
    ...
    public function setDenialStatusCode(?int $denial_status_code): static
    {
        if (is_null($denial_status_code)) {
            throw new InvalidArgumentException('non-nullable denial_status_code cannot be null');
        }
    ...
    public function setPhoneNumber(?string $phone_number): static
    {
        ...
        if ((mb_strlen($phone_number) > 12)) {
            throw new InvalidArgumentException('invalid length for $phone_number when calling VerificationDenialWebhook., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($phone_number) < 12)) {
            throw new InvalidArgumentException('invalid length for $phone_number when calling VerificationDenialWebhook., must be bigger than or equal to 12.');
        }
        if ((!preg_match("/^\\+1(800|833|844|855|866|877|888)[2-9]\\d{6}$/", ObjectSerializer::toString($phone_number)))) {
            throw new InvalidArgumentException("invalid value for \$phone_number when calling VerificationDenialWebhook., must conform to the pattern /^\\+1(800|833|844|855|866|877|888)[2-9]\\d{6}$/.");
        }
