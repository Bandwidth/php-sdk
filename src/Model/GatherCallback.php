...
/**
 * GatherCallback Class Doc Comment
 *
 ...
 */
class GatherCallback implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'gatherCallback';
    ...
    protected static array $setters = [
        ...
        'terminating_digit' => 'setTerminatingDigit',
    ...
    protected static array $getters = [
        ...
        'terminating_digit' => 'getTerminatingDigit',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('terminating_digit', $data ?? [], null);
     ...
     * Sets digits
     *
     * @param string|null $digits (optional) The digits, letters, and/or symbols entered by the user. The string is empty if a timeout occurred before any buttons were pressed.
     *
     * @return $this
     */
    ...
    /**
     * Gets terminating_digit
     *
     * @return string|null
     */
    public function getTerminatingDigit(): ?string
    {
        return $this->container['terminating_digit'];
    }

    /**
     * Sets terminating_digit
     *
     * @param string|null $terminating_digit (optional) The digit the user pressed to end the gather. Empty string value if no terminating digit was pressed.
     *
     * @return $this
     */
    public function setTerminatingDigit(?string $terminating_digit): static
    {
        if (is_null($terminating_digit)) {
            throw new InvalidArgumentException('non-nullable terminating_digit cannot be null');
        }
        $this->container['terminating_digit'] = $terminating_digit;
