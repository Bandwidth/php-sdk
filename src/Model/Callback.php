...
class Callback implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'callback';
    ...
    public const TYPE_MESSAGE_FAILED = 'message-failed';
    public const TYPE_MESSAGE_READ = 'message-read';
    public const TYPE_MESSAGE_RECEIVED = 'message-received';
    public const TYPE_MESSAGE_SENDING = 'message-sending';
    public const TYPE_MESSAGE_SENT = 'message-sent';
    public const TYPE_REQUESTED_LOCATION_RESPONSE = 'requested-location-response';
    public const TYPE_SUGGESTION_RESPONSE = 'suggestion-response';
     ...
     * Sets to
     *
     * @param string $to The destination phone number the message was sent to. For inbound callbacks, this is the Bandwidth number or alphanumeric identifier that received the message.
     *
     * @return $this
     */
