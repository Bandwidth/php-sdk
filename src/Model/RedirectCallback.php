...
/**
 * RedirectCallback Class Doc Comment
 *
 ...
 */
class RedirectCallback implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'redirectCallback';
