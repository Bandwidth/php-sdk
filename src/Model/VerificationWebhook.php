 ...
 */
class VerificationWebhook implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'verificationWebhook';
    ...
    public function setPhoneNumber(?string $phone_number): static
    {
        ...
        if ((mb_strlen($phone_number) > 12)) {
            throw new InvalidArgumentException('invalid length for $phone_number when calling VerificationWebhook., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($phone_number) < 12)) {
            throw new InvalidArgumentException('invalid length for $phone_number when calling VerificationWebhook., must be bigger than or equal to 12.');
        }
        if ((!preg_match("/^\\+1(800|833|844|855|866|877|888)[2-9]\\d{6}$/", ObjectSerializer::toString($phone_number)))) {
            throw new InvalidArgumentException("invalid value for \$phone_number when calling VerificationWebhook., must conform to the pattern /^\\+1(800|833|844|855|866|877|888)[2-9]\\d{6}$/.");
        }
