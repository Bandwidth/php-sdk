 ...
 */
class SipConnectionMetadata implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'sipConnectionMetadata';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('uui_header', $data ?? [], null);
    }
     ...
     * Sets ip_address
     *
     * @param string|null $ip_address The IP address of the SIP connection.
     *
     * @return $this
     */
     ...
     * Sets port
     *
     * @param int|null $port The port of the SIP connection.
     *
     * @return $this
     */
     ...
     * @return string|null
     */
    public function getUuiHeader(): ?string
    {
        return $this->container['uui_header'];
    }

    /**
     * Sets uui_header
     *
     * @param string|null $uui_header The User-to-User Information header for the SIP connection.
     *
     * @return $this
     */
    public function setUuiHeader(?string $uui_header): static
    {
        if (is_null($uui_header)) {
            throw new InvalidArgumentException('non-nullable uui_header cannot be null');
        }
        $this->container['uui_header'] = $uui_header;
