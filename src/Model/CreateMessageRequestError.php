 ...
 */
class CreateMessageRequestError implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'createMessageRequestError';
     ...
     * @return $this
     */
    public function setFieldErrors(?array $field_errors): static
    {
