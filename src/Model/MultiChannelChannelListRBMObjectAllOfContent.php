 ...
 */
class MultiChannelChannelListRBMObjectAllOfContent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'multiChannelChannelListRBMObject_allOf_content';
     ...
     * Sets text
     *
     * @param string $text The text associated with the message. Must be 3270 characters or less
     *
     * @return $this
     */
    public function setText(string $text): static
    {
        ...
        if ((mb_strlen($text) > 3270)) {
            throw new InvalidArgumentException('invalid length for $text when calling MultiChannelChannelListRBMObjectAllOfContent., must be smaller than or equal to 3270.');
        }
    ...
    public function setSuggestions(?array $suggestions): static
    {
        ...
        if ((count($suggestions) > 11)) {
            throw new InvalidArgumentException('invalid value for $suggestions when calling MultiChannelChannelListRBMObjectAllOfContent., number of items must be less than or equal to 11.');
        }
    ...
    public function setCardContents(array $card_contents): static
    {
        ...
        if ((count($card_contents) > 10)) {
            throw new InvalidArgumentException('invalid value for $card_contents when calling MultiChannelChannelListRBMObjectAllOfContent., number of items must be less than or equal to 10.');
        }
        if ((count($card_contents) < 2)) {
            throw new InvalidArgumentException('invalid length for $card_contents when calling MultiChannelChannelListRBMObjectAllOfContent., number of items must be greater than or equal to 2.');
        }
