 ...
 */
class MultiChannelChannelListSMSResponseObject implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'multiChannelChannelListSMSResponseObject';
