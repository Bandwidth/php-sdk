 ...
 */
class CreateMultiChannelMessageResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'createMultiChannelMessageResponse';
