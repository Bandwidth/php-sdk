...
/**
 * VoiceCodeResponse Class Doc Comment
 *
 * @package  Bandwidth
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VoiceCodeResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'voiceCodeResponse';
     ...
     * Sets call_id
     *
     * @param string|null $call_id Programmable Voice API Call ID.
     *
     * @return $this
     */
