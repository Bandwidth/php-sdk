 ...
 */
class TranscriptionAvailableCallback implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'transcriptionAvailableCallback';
