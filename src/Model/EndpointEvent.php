 ...
 */
class EndpointEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'endpointEvent';
     ...
     * Sets event_time
     *
     * @param \DateTime $event_time The time the event occurred. In ISO-8601 format.
     *
     * @return $this
     */
