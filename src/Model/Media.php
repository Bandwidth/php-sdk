...
class Media implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('media_name', $data ?? [], null);
    }
     ...
     * @return $this
     */
    public function setContentLength(?int $content_length): static
    {
     ...
     * Sets media_name
     *
     * @param string|null $media_name media_name
     *
     * @return $this
     */
    public function setMediaName(?string $media_name): static
    {
        if (is_null($media_name)) {
            throw new InvalidArgumentException('non-nullable media_name cannot be null');
        }
