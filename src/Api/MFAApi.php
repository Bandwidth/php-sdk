...
class MFAApi
{
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \Bandwidth\Model\MessagingCodeResponse|\Bandwidth\Model\MfaRequestError|\Bandwidth\Model\MfaUnauthorizedRequestError|\Bandwidth\Model\MfaForbiddenRequestError, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    ...
    ): Request
    {
        ...
        if (isset($code_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($code_request), JSON_THROW_ON_ERROR);
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \Bandwidth\Model\VoiceCodeResponse|\Bandwidth\Model\MfaRequestError|\Bandwidth\Model\MfaUnauthorizedRequestError|\Bandwidth\Model\MfaForbiddenRequestError, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \Bandwidth\Model\VerifyCodeResponse|\Bandwidth\Model\MfaRequestError|\Bandwidth\Model\MfaUnauthorizedRequestError|\Bandwidth\Model\MfaForbiddenRequestError, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    ...
    ): Request
    {
        ...
        if (isset($verify_code_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($verify_code_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
