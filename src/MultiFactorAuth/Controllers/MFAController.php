...
class MFAController extends BaseController
{
    ...
    public function createVoiceTwoFactor(
        ...
        if ($response->code == 400) {
            throw new Exceptions\ErrorWithRequestErrorException(
        ...
        if ($response->code == 401) {
            throw new Exceptions\UnauthorizedRequestErrorException(
        ...
        if ($response->code == 403) {
            throw new Exceptions\ForbiddenRequestErrorException(
        ...
        if ($response->code == 500) {
            throw new Exceptions\ErrorWithRequestErrorException('An internal server error occurred', $_httpContext);
        }
