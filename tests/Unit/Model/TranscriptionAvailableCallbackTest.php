...
use Bandwidth\Model\TranscriptionAvailableCallback;
...
{
    private static TranscriptionAvailableCallback $instance;
    ...
    {
        self::$instance = new TranscriptionAvailableCallback([
    ...
    {
        $this->assertInstanceOf(TranscriptionAvailableCallback::class, self::$instance);
    }
    ...
    {
        $this->assertInstanceOf(Transcription::class, self::$instance->getTranscription());
    }
