...
use Bandwidth\Model\GatherCallback;

use PHPUnit\Framework\TestCase;

/**
 * GatherCallbackTest Class Doc Comment
 *
 ...
 * @link        https://openapi-generator.tech
 */
class GatherCallbackTest extends TestCase
{
    private static GatherCallback $instance;
    ...
    {
        self::$instance = new GatherCallback([
     ...
     * Test "GatherCallback"
     */
    public function testGatherCallback()
    {
        $this->assertInstanceOf(GatherCallback::class, self::$instance);
    }
    ...
    {
        $this->assertIsString(self::$instance->getDigits());
        $this->assertEquals('test_string', self::$instance->getDigits());
    }
