...
use Bandwidth\Model\TransferAnswerCallback;
...
{
    private static TransferAnswerCallback $instance;
    ...
    {
        self::$instance = new TransferAnswerCallback([
    ...
    {
        $this->assertInstanceOf(TransferAnswerCallback::class, self::$instance);
    }
