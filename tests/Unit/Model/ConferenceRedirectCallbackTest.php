...
use Bandwidth\Model\ConferenceRedirectCallback;
...
{
    private static ConferenceRedirectCallback $instance;
    ...
    {
        self::$instance = new ConferenceRedirectCallback([
    ...
    {
        $this->assertInstanceOf(ConferenceRedirectCallback::class, self::$instance);
    }
