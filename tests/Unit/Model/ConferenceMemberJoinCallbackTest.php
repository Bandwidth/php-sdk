<?php
/**
 * ConferenceMemberJoinCallbackTest
 *
 * PHP version 8.1
 *
 * @package  Bandwidth
...
use Bandwidth\Model\ConferenceMemberJoinCallback;

use PHPUnit\Framework\TestCase;

/**
 * ConferenceMemberJoinCallbackTest Class Doc Comment
 *
 ...
 * @link        https://openapi-generator.tech
 */
class ConferenceMemberJoinCallbackTest extends TestCase
{
    private static ConferenceMemberJoinCallback $instance;
    ...
    {
        self::$instance = new ConferenceMemberJoinCallback([
     ...
     */
    public function testConferenceMemberJoinCallback()
    {
        $this->assertInstanceOf(ConferenceMemberJoinCallback::class, self::$instance);
    }
