...
use Bandwidth\Model\TransferCompleteCallback;
...
{
    private static TransferCompleteCallback $instance;
    ...
    {
        self::$instance = new TransferCompleteCallback([
    ...
    {
        $this->assertInstanceOf(TransferCompleteCallback::class, self::$instance);
    }
